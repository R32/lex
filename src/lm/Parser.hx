...
typedef Lhs = {    // left hand side of the production which is generated by a switch expr
	...
	side: Bool,    // if variable name defined with "@:side"(something like the ocamlyacc's "%start xxxxxx")
...
class Parser {
	...
	public function new(s_interface: String, rest: Map<String, Field>) {
