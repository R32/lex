...
* [x] Parser: **Rollback-Able LR0**(Need More Tests)
  - [ ] Operator Priority
...
`haxe -dce full -D lex_switch -D analyzer-optimize -D nodejs -lib lex-macro -main Demo -js demo.js`
